            ...
            <Row>
              ...
              <Col md="12">
                <div className="ourm mb-50">
                  <h2>OUR STORY</h2>
                  <p>
                    AstroVipra came into being with an aim to not only keep the
                    ...
                    consultation, AstroVipra, besides allowing you to talk to
